...
int main(int argc, char* argv[]) {
    ...
    Mix_Music* backgroundSound = Mix_LoadMUS("song for game .mp3");
    ...
    SDL_Window* window = SDL_CreateWindow(u8" 87216354Мемо",
    ...
    while (gameRunning) { 
        ...
        Card cards[30];
        CartochnoePole(cards, cardCol, SCREEN_WIDTH, SCREEN_HEIGHT,renderer);
        bool running = true;
        SDL_Event e;
        int selected = 0;
